...
class BestItemSectionRecyclerViewAdapter(private val mValues: List<*>,
                                         private val mListener: InteractionListener<Subject>?,
                                         private val context: Context):
    RecyclerView.Adapter<BestItemSectionRecyclerViewAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(item.thumbnailImage).centerCrop().transition(
